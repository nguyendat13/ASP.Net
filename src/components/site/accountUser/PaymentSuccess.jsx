...
const PaymentSuccess = () => (
  <div className="d-flex flex-column align-items-center justify-content-center" style={{ minHeight: '60vh', background: '#23272a' }}>
    ...
    <h2 className="fw-bold mt-3" style={{ color: '#ff9800', letterSpacing: 1 }}>
    ...
    <div className="d-flex gap-3 mt-4">
      <a href="/" className="btn btn-dark d-flex align-items-center gap-2 shadow-sm" style={{ borderRadius: 8, fontWeight: 500, background: '#23272a', color: '#ff9800', border: 'none' }}>
      ...
      <a href="/orders" className="btn btn-success d-flex align-items-center gap-2 shadow-sm" style={{ borderRadius: 8, fontWeight: 500, background: '#43a047', color: '#fff', border: 'none' }}>
        <FaCheckCircle style={{ color: '#fbc02d', fontSize: 20 }} /> Xem đơn hàng
      </a>
    </div>
  </div>
);
